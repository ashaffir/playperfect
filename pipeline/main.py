...
def update_tables(request):
    ...
    job_config = bigquery.LoadJobConfig(
        ...
        write_disposition=bigquery.WriteDisposition.WRITE_TRUNCATE,  # Replace data in new_raw_events
    )
    ...
    print(f"Loaded new data into {new_raw_events_table}")
    ...
    print("Appended new data to raw_events")
